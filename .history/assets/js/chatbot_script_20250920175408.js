    ...
    try {
        ...
        if (bodyObject.answer && bodyObject.answer.trim() !== '') {
            ...
            if (bodyObject.error) {
                ...
                answer = 'Sorry, I ran out of processing capacity for that question. Could you retry in a few minutes, asking a shorter or more specific question about my background?';
            }
        }
